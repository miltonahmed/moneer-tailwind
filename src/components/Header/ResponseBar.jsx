...
const ResponseBar = ({showBars, setShowBars }) => {
  return (
    <div
      className={`min-w-[320px] h-full bg-navBg/80  px-6 py-18 fixed top-0 right-0 z-50 lg:hidden transition-all duration-300 ${showBars ? "translate-x-0" :"translate-x-full"}
      `}>
      {/* close icons  */}
